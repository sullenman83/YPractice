...
namespace Events.UnitTests
{
    public class EventServiceTest
    {
        ...
        public async Task CreateEvent_ReturnNewEvent()
        {
            ...
            var service = new EventService(_mockValidator.Object, _mockEventRepository.Object);
        ...
        public async Task Updatevents_InvalidDate_ThrowsEventValidationException()
        {
            ...
            var service = new EventService(new EventValidator(), _mockEventRepository.Object);
